...
def create_user(email='user@example.com', password='t_pass123'):
...
class PrivateIngredientApiTests(TestCase):
    ...
    def test_ingredients_limited_to_user(self):
        ...
        user_2 = create_user('another_user@example.com', 'tp_12345')
    ...
    def test_ingredients_assigned_to_recipes(self):
        ...
        ing2 = Ingredient.objects.create(user=self.user, name='Eggs')
